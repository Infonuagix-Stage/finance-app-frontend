...
const resources = {
  en: { about: enAbout, budgeting: enBudgeting, dashboard: enDashboard, general: enGeneral, homepage: enHomepage, layouts: enLayouts, payement: enPayement, project: enProject },
  fr: { about: frAbout, budgeting: frBudgeting, dashboard: frDashboard, general: frGeneral, homepage: frHomepage, layouts: frLayouts, payement: frPayement, project: frProject },
};
